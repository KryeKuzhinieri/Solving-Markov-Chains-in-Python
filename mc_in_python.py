# Problem Description:
#Suppose each box of Corn Snaps cereal contains one of 5 different Harry Potter trading cards.
#Moreover, suppose that once you complete a set of cards, you give decide to sell it 
#and restart collecting them again. The probability of getting a card is  1/5.
...
#Let's take the problem step by step. Firstly, let's define our states and our decision variable.
        #X(t): The unique number of trading cards.
        #States: (0, 1, 2, 3, 4, 5) (You cannot have nonpositive or more than 5 unique cards since we are given a total of 5 cards in the problem.)
...
#2. We are looking for Steady State Probabilites: $$\pi_3 = \sum_{i=1}^{5} \pi_i * p_{i3} \quad for \quad j = 0,1,2,...., 5$$
...
#2. We are looking for Mean Passage Times: $$ m_{05} = 1 + \sum_{k \neq 5} P_{0k} * m_{k5} $$
